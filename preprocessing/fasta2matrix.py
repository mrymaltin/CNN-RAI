...
def make_sequence_vector (sequence,
    ...
    for k in k_values:
        ...
        for i_seq in range(0, seq_length):
            ...
            # Increment the count.
            if (operator.contains(kmer_counts[bin_num],(kmer))):
                ...
                for i_kmer in range(0, k):
                    for letter in alphabet:
                        ...
                        if (kmer[i_kmer:i_kmer+1] != letter):
                            ...
                            if (operator.contains(kmer_counts[bin_num],neighbor)):
    ...
    for i_bin in range(0, num_bins):
        for kmer in kmer_list:
            if (operator.contains(kmer_counts[i_bin],kmer)):
...
def find_revcomp (sequence,
    ...
    if (operator.contains(revcomp_dictionary,sequence)):
...
#   sys.exit(1)
k = 5
fasta_filename = "./dataset/500r9.fasta"
output_filename = "500r9_5k.txt"
